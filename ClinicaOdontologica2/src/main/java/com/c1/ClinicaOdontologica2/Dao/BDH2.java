...
public class BDH2 {
    private static final String SQL_CREATE="DROP TABLE IF EXISTS ODONTOLOGOS; " +
            "CREATE TABLE ODONTOLOGOS (ID INT AUTO_INCREMENT PRIMARY KEY, MATRICULA VARCHAR(100) NOT NULL, NOMBRE VARCHAR(20) NOT NULL, APELLIDO VARCHAR(20) NOT NULL);" +
...
private static final String sql_prueba="" +
        ...
        "INSERT INTO ODONTOLOGOS (MATRICULA, NOMBRE, APELLIDO) VALUES ('O1', 'Anderson','Martinez'),('O2', 'Camilo','Sexto')";
...
public static void crearTabla(){
    ...
    public static Connection getConnnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:~/BDclinicaOdontologica","a","a");
    }
}
