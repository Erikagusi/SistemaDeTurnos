...
public class BDH2 {
    private static final String SQL_CREATE="DROP TABLE IF EXISTS ODONTOLOGOS; " +
            ...
            "CREATE TABLE PACIENTES (ID INT AUTO_INCREMENT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL, CEDULA VARCHAR(20) NOT NULL, FECHA_INGRESO DATE NOT NULL, DOMICILIO_ID, EMAIL VARCHAR(100) NOT NULL);" +
...
private static final String sql_prueba="INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID, EMAIL) VALUES('Erika', 'Guarin', '123', '2'23-08-09', 1, 'Erika@hotmail.com'), ('Andy', 'Castellanos', '234', '2022-09-01', 2,'andy@hotmail.com'); "+
